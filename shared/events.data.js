...
export const INITIAL_EVENTS = [
  {
    ...
    maxParticipants: 12,
    participantsCount: 8,
    telegramBotUrl: 'https://t.me/LiveInMomentBot',
    priceType: 'paid',
    priceLabel: '50 BYN с одного человека (аренда бани солидарно)',
    entryThreshold: 'Только Мужчины • 100% Трезвость • Личный веник на совесть',
  ...
  },
  {
    ...
    telegramBotUrl: 'https://t.me/LiveInMomentBot',
    priceType: 'paid',
    priceLabel: 'Ориентировочно 55 BYN (аренда бани солидарно)',
