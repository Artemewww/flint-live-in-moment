...
function clubRuleSteps(): Step[] {
  return [
    ...
    {
      /**
       * Бади и порча чужого. Правило добавлено после Нарочи: участник разбил
       * чужой термос, а бади пострадавшей отказалась вести вопрос — «в правилах
       * этого не написано». Теперь написано: и про бади, и про то, что
