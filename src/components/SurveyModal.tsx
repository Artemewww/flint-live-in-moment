...
export default function SurveyModal({ eventId, eventTitle, onClose, onSubmit }: SurveyModalProps) {
  ...
  return (
    <AnimatePresence>
      {eventId && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" id="survey-modal-root">
          {/* Backdrop */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
