...
import { QUALITIES as SHARED_QUALITIES, INITIAL_EVENTS as SHARED_EVENTS, getToday as sharedGetToday } from '../shared/events.data.js';
...
/** Динамическая дата «сегодня» — единая для всего приложения. */
export const getToday = sharedGetToday;
